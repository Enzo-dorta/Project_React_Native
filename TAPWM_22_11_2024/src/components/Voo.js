...
import Icon from 'react-native-vector-icons/MaterialIcons'; // Biblioteca para ícones (instale com `npm install react-native-vector-icons`).
import { useNavigation } from '@react-navigation/native'; // Certifique-se de usar `react-navigation` no projeto.
